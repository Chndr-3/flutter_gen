...
class $AssetsDeferredComponentGen {
  const $AssetsDeferredComponentGen();

  /// Directory path: assets/deferred_component/images
  $AssetsDeferredComponentImagesGen get images =>
      const $AssetsDeferredComponentImagesGen();
}
...
class $AssetsDeferredComponentImagesGen {
  const $AssetsDeferredComponentImagesGen();

  /// File path: assets/deferred_component/images/chip1.jpg
  AssetGenImage get chip1 =>
      const AssetGenImage('assets/deferred_component/images/chip1.jpg');
...
class $AssetsImages20xGen {
  ...
  /// File path: assets/images/2.0x/chip1.jpg
  AssetGenImage get chip1 =>
      const AssetGenImage('assets/images/2.0x/chip1.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [chip1];
}

class $AssetsImages30xGen {
  const $AssetsImages30xGen();

  /// File path: assets/images/3.0x/chip1.jpg
  AssetGenImage get chip1 =>
      const AssetGenImage('assets/images/3.0x/chip1.jpg');
